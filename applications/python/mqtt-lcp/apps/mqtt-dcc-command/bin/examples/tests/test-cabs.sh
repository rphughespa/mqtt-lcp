...
mosquitto_pub -h mqtt-broker.local -u trains -P choochoo \
 -t 'cmd/mqtt-lcp/switch/'$HOSTNAME'-dcc_command/power/req' \
...
echo "connect A"
mosquitto_pub -h mqtt-broker.local -u trains -P choochoo \
 -t 'cmd/mqtt-lcp/cab/'$HOSTNAME'-dcc_command/desktop-throttle-a/req' \
...
echo "connect B"
mosquitto_pub -h mqtt-broker.local -u trains -P choochoo \
 -t 'cmd/mqtt-lcp/cab/'$HOSTNAME'-dcc_command/handheld-throttle-b/req' \
...
mosquitto_pub -h mqtt-broker.local -u trains -P choochoo \
 -t 'cmd/mqtt-lcp/cab/'$HOSTNAME'-dcc_command/desktop-throttle-b/req' \
...
mosquitto_pub -h mqtt-broker.local -u trains -P choochoo \
 -t 'cmd/mqtt-lcp/cab/'$HOSTNAME'-dcc_command/desktop-throttle-b/req' \
 -m '{"cab": {"version": "1.0", "timestamp": 1577804139, "session-id": "req:1577804139", "node-id": "handheld-throttle",  "throttle-id": "34abcd",  "cab-id": "cab-b", "loco-id": 7654, "respond-to": "cmd/mqtt-lcp/node/throttle1/res", "state": {"desired": "acquire"}}}'

sleep 4
echo "acquire loco for cab-2"
mosquitto_pub -h mqtt-broker.local -u trains -P choochoo \
 -t 'cmd/mqtt-lcp/cab/'$HOSTNAME'-dcc_command/desktop-throttle-b/req' \
 -m '{"cab": {"version": "1.0", "timestamp": 1577804139, "session-id": "req:1577804139", "node-id": "handheld-throttle",  "throttle-id": "34abcd",  "cab-id": "cab-b", "loco-id": 8765, "respond-to": "cmd/mqtt-lcp/node/throttle1/res", "state": {"desired": "acquire"}, "metadata":{"facing":"reverse"}}}'
...
mosquitto_pub -h mqtt-broker.local -u trains -P choochoo \
 -t 'cmd/mqtt-lcp/cab/'$HOSTNAME'-dcc_command/desktop-throttle-b/req' \
 -m '{"cab": {"version": "1.0", "timestamp": 1577804139, "session-id": "req:1577804139", "node-id": "handheld-throttle",  "throttle-id": "34abcd",  "cab-id": "cab-b", "loco-id": 9876, "respond-to": "cmd/mqtt-lcp/node/throttle1/res", "state": {"desired": "acquire"}}}'
...
sleep 4
echo "set direction for cab-2"
mosquitto_pub -h mqtt-broker.local -u trains -P choochoo \
 -t 'cmd/mqtt-lcp/cab/'$HOSTNAME'-dcc_command/desktop-throttle-b/req' \
 -m '{"cab": {"version": "1.0", "timestamp": 1577804139, "session-id": "req:1577804139", "node-id": "handheld-throttle",  "throttle-id": "34abcd",  "cab-id": "cab-b", "respond-to": "cmd/mqtt-lcp/node/throttle1/res", "state": {"desired": {"direction":"forward"}}}}'

sleep 4
echo "move loco for cab-2"
mosquitto_pub -h mqtt-broker.local -u trains -P choochoo \
 -t 'cmd/mqtt-lcp/cab/'$HOSTNAME'-dcc_command/desktop-throttle-b/req' \
 -m '{"cab": {"version": "1.0", "timestamp": 1577804139, "session-id": "req:1577804139", "node-id": "handheld-throttle",  "throttle-id": "34abcd",  "cab-id": "cab-b", "respond-to": "cmd/mqtt-lcp/node/throttle1/res", "state": {"desired": {"speed":10}}}}'

sleep 2

echo "get loco status for cab-2"
mosquitto_pub -h mqtt-broker.local -u trains -P choochoo \
 -t 'cmd/mqtt-lcp/cab/'$HOSTNAME'-dcc_command/desktop-throttle-b/req' \
 -m '{"cab": {"version": "1.0", "timestamp": 1577804139, "session-id": "req:1577804139", "node-id": "handheld-throttle",  "throttle-id": "34abcd",  "cab-id": "cab-b",  "respond-to": "cmd/mqtt-lcp/node/throttle1/res", "state": {"desired": {"report":"speed"}}}}'

sleep 4

echo "stop loco for cab-2"
mosquitto_pub -h mqtt-broker.local -u trains -P choochoo \
 -t 'cmd/mqtt-lcp/cab/'$HOSTNAME'-dcc_command/desktop-throttle-b/req' \
 -m '{"cab": {"version": "1.0", "timestamp": 1577804139, "session-id": "req:1577804139", "node-id": "handhelp-throttle",  "throttle-id": "34abcd",  "cab-id": "cab-b",  "respond-to": "cmd/mqtt-lcp/node/throttle1/res", "state": {"desired": {"speed":0}}}}'

sleep 4

echo "set direction loco for cab-2"
mosquitto_pub -h mqtt-broker.local -u trains -P choochoo \
 -t 'cmd/mqtt-lcp/cab/'$HOSTNAME'-dcc_command/desktop-throttle-b/req' \
 -m '{"cab": {"version": "1.0", "timestamp": 1577804139, "session-id": "req:1577804139", "node-id": "handheld-throttle",  "throttle-id": "34abcd",  "cab-id": "cab-b", "respond-to": "cmd/mqtt-lcp/node/throttle1/res", "state": {"desired": {"direction":"reverse"}}}}'
...
echo "repoprt loco status cab-2"
mosquitto_pub -h mqtt-broker.local -u trains -P choochoo \
 -t 'cmd/mqtt-lcp/cab/'$HOSTNAME'-dcc_command/desktop-throttle-b/req' \
 -m '{"cab": {"version": "1.0", "timestamp": 1577804139, "session-id": "req:1577804139", "node-id": "handheld-throttle",  "throttle-id": "34abcd",  "cab-id": "cab-b", "respond-to": "cmd/mqtt-lcp/node/throttle1/res", "state": {"desired": {"report":"direction"}}}}'
...
mosquitto_pub -h mqtt-broker.local -u trains -P choochoo \
 -t 'cmd/mqtt-lcp/cab/'$HOSTNAME'-dcc_command/desktop-throttle-b/req' \
 -m '{"cab": {"version": "1.0", "timestamp": 1577804139, "session-id": "req:1577804139", "node-id": "handheld-throttle",  "throttle-id": "34abcd",  "cab-id": "cab-b", "respond-to": "cmd/mqtt-lcp/node/throttle1/res", "state": {"desired": {"speed":0}}}}'
...
sleep 4
echo "set lead loco for cab-2"
mosquitto_pub -h mqtt-broker.local -u trains -P choochoo \
 -t 'cmd/mqtt-lcp/cab/'$HOSTNAME'-dcc_command/desktop-throttle-b/req' \
 -m '{"cab": {"version": "1.0", "timestamp": 1577804139, "session-id": "req:1577804139", "node-id": "handheld-throttle",  "throttle-id": "34abcd",  "cab-id": "cab-b", "loco-id": 8765, "respond-to": "cmd/mqtt-lcp/node/throttle1/res", "state": {"desired": "set-lead"}}}'
...
sleep 4
echo "bell on loco for cab-2"
mosquitto_pub -h mqtt-broker.local -u trains -P choochoo \
 -t 'cmd/mqtt-lcp/cab/'$HOSTNAME'-dcc_command/desktop-throttle-b/req' \
 -m '{"cab": {"version": "1.0", "timestamp": 1577804139, "session-id": "req:1577804139", "node-id": "handheld-throttle",  "throttle-id": "34abcd",  "cab-id": "cab-b",  "respond-to": "cmd/mqtt-lcp/node/throttle1/res", "state": {"desired": {"function":1, "state":"on"}}}}'

sleep 4

echo "bell off loco for cab-2"
mosquitto_pub -h mqtt-broker.local -u trains -P choochoo \
 -t 'cmd/mqtt-lcp/cab/'$HOSTNAME'-dcc_command/desktop-throttle-b/req' \
 -m '{"cab": {"version": "1.0", "timestamp": 1577804139, "session-id": "req:1577804139", "node-id": "handheld-throttle",  "throttle-id": "34abcd",  "cab-id": "cab-b",  "respond-to": "cmd/mqtt-lcp/node/throttle1/res", "state": {"desired": {"function":1, "state":"off"}}}}'
sleep 4
echo "bell on loco for cab-2"
mosquitto_pub -h mqtt-broker.local -u trains -P choochoo \
 -t 'cmd/mqtt-lcp/cab/'$HOSTNAME'-dcc_command/desktop-throttle-b/req' \
 -m '{"cab": {"version": "1.0", "timestamp": 1577804139, "session-id": "req:1577804139", "node-id": "handheld-throttle",  "throttle-id": "34abcd",  "cab-id": "cab-b",  "respond-to": "cmd/mqtt-lcp/node/throttle1/res", "state": {"desired": {"function":5, "state":"on"}}}}'
...
mosquitto_pub -h mqtt-broker.local -u trains -P choochoo \
 -t 'cmd/mqtt-lcp/cab/'$HOSTNAME'-dcc_command/desktop-throttle-b/req' \
 -m '{"cab": {"version": "1.0", "timestamp": 1577804139, "session-id": "req:1577804139", "node-id": "handheld-throttle",  "throttle-id": "34abcd",  "cab-id": "cab-b",  "respond-to": "cmd/mqtt-lcp/node/throttle1/res", "state": {"desired": {"function":5, "state":"off"}}}}'
